...
* **Pillar 4: AI-Powered Reporting** (`reporting.py`)
    * Synthesizes all the quantitative and qualitative data from the first three pillars.
    * Prompts an LLM to act as a portfolio manager, creating a structured, comprehensive investment memo that includes an executive summary, a SWOT analysis, and a final "Buy/Hold/Sell" recommendation.

## Features

* **Automated Data Gathering:** Pulls data directly from `yfinance`.
* **Quantitative & Qualitative:** Merges hard numbers (ratios, DCF) with soft analysis (macro trends, competition).
* **LLM Integration:** Leverages a local LLM (`llama3:8b`) for nuanced analysis and report generation, ensuring privacy and zero API costs.
...
1. **Clone the Repository**
   ```bash
   git clone [https://github.com/abhizz11/AI-Stock-Analyzer.git](https://github.com/abhizz11/AI-Stock-Analyzer.git)
...
3. **Install and Setup Ollama**
  ...
  * **Once Ollama is running, pull the required model:**
    ```bash
...
1. **Run the Main Script**
   ...
   python main.py
   ```
2. **Enter a ticker when prompted (e.g., NVDA).**
3. **View Technical Charts. (Note: The charts must be closed for the analysis to continue.)**
